...
def build_resnet_snapshot(M, alpha_zero, x_train, y_train, x_test, y_test, batch_size, epochs, n, version, data_augmentation, name_prefix):
    # Training parameters
    # batch_size = 32
    # epochs = 200
...
# Prepare model model saving directory.
    ...
    model_name = 'cifar10_%s_model.{epoch:03d}.{val_acc:0.6f}.h5' % model_type
...
# Prepare callbacks for model saving and for learning rate adjustment.
    ...
    '''
    callbacks = snapshot.get_callbacks(model_prefix=name_prefix)
...
def build_resnet(x_train, y_train, x_test, y_test, batch_size, epochs, n, version, data_augmentation, name_prefix):
# Training parameters
    # batch_size = 32
    # epochs = 200
    # data_augmentation = True
...
if __name__ == "__main__":
    ...
    # model = load_model("bagging.0.final.hdf5")
    # evaluate(model, x_test, y_test)
    # model, history = build_resnet(x_train, y_train, x_test, y_test, batch_size, epochs, n, version, data_augmentation=True, name_prefix="test")
